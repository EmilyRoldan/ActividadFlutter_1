...
class TTexTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 34.0, fontWeight: FontWeight.bold, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 34, fontWeight: FontWeight.bold, color: Colors.white),
